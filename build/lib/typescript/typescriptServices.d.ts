declare module ts {
    ...
    interface Program extends ScriptReferenceHost {
        /**
         * obtém uma lista completa dos arquivos do programa
         */
    ...
    interface SourceMapSpan {
        /** número da linha do arquivo .js */
        emittedLine: number;

        /** número da coluna do arquivo .js */
        emittedColumn: number;
        
        /** número da linha do arquivo .ts */
        sourceLine: number;
        
        /** número da coluna do arquivo .ts */
        sourceColumn: number;
        
        /** nome opcional associado com esse span */
        nameIndex?: number;
        
        /** arquivo .ts associado com esse span */
        sourceIndex: number;
    }
    ...
    /** retorna o código utilizado pela função getEmitOutput para indicar o status da função */
    enum ExitStatus {
        Success = 0,
...
declare module ts {
    /** a versão do compilador do typescript */
...
declare module ts {
    ...
    /**
      * ler arquivo tsconfig.json
      * @param fileName o caminho do arquivo de configuração
      */
    ...
    /**
      * captura o texto do arquivo tsconfig.json
      * @param fileName o caminho do arquivo de configuração
      * @param jsonText o texto do arquivo de configuração
      */
    ...
    /**
      * captura os conteúdos do arquivo de configuração (tsconfig.json)
      * @param json os conteúdos do arquivo de configuração a serem capturados
      * @param basePath um diretório root para resolver caminho relativo no arquivo de configuração
      */
    function parseConfigFile(json: any, host: ParseConfigHost, basePath: string): ParsedCommandLine;
}

declare module ts {
    /** a versão da api do serviço de linguagem */
    ...
    interface IScriptSnapshot {
        /** obtém a portação do snapshot do script especificado pelo [início, fim). */
        getText(start: number, end: number): string;

        /** obtém o tamanho do snapshot do script */
        getLength(): number;
    ...
    interface LanguageService {
        ...
        /**
         * @deprecated utilizar getEncodedSyntacticClassifications em vez disso
         */
        getSyntacticClassifications(fileName: string, span: TextSpan): ClassifiedSpan[];
        
        /**
         * @deprecated utilizar getEncodedSemanticClassifications em vez disso
         */
